...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1 class="display-6 mb-2">Informasi Mahasiswa!</h1>
    ...
    <section id="content" class="container ">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <h1 class="card-title">Tentang saya </h1>
                        <p> nama:{{ $name }} </p>
                        <p> tanggal lahir:{{ $my_age }}  </p>
                         <p> Tanggal Harus Wisuda:{{ $tgl_harus_wisuda }} </p>
                          <p> jarak_tahun wisuda:{{ $time_to_study_left }} tahun  </p>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <span class="badge text-bg-primary">Hobi</span>
